...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admini Forget Password</title>
    ...
    <!-- <body data-layout="horizontal"> -->
        ...
        @endif
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> EasyLearning   . Crafted with <i class="mdi mdi-heart text-danger"></i> by EasyLearning</p>
                                    </div>
                                </div>
                            </div>
                        </div>
